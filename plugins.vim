...
Plug 'HerringtonDarkholme/yats.vim', {'for': 'typescript'}  "syntax for ts

" Plug 'tomtom/quickfixsigns_vim' " show signs for error messages
" Elm
...
Plug 'takac/vim-hardtime' "committing to vim
